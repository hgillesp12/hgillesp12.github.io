      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none text-muted-foreground">
          <p className="mb-6 leading-relaxed">
            I am a 2023 Marshall Scholar and a 2020 graduate of the University of Notre Dame, where I earned a B.S. in Mechanical Engineering with a minor in Theology. My work sits at the intersection of high-stakes engineering and international development, driven by a commitment to sustainable, human-centered solutions.
          </p>
          <p className="mb-6 leading-relaxed">
          ...
          <p className="leading-relaxed">
            Currently, I am an Autonomous Systems Engineer at Boeing and serve on the board of Ascend NW, a Catholic non-profit in the Pacific Northwest. I am passionate about leveraging my background in engineering for sustainable development to create a more equitable and resilient future.
          </p>
        </div>
      </div>
    </section>
